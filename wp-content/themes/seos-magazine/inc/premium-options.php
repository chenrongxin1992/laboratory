	...
	<form class="theme-options" method="post" action="options.php" accept-charset="ISO-8859-1">
		...
		<div class="seos-magazine">
			<a target="_blank" href="https://seosthemes.com/seos-magazine/">
				<div class="btn s-red">
					 <?php _e('Buy', 'seos-magazine'); ?> <img class="ss-logo" src="<?php echo get_template_directory_uri() . '/images/logo.png'; ?>"/><?php _e(' Now', 'seos-magazine'); ?>
				</div>
			</a>
		</div>
		
		<div class="cb-center">	
			<img class="sb-demo" src="<?php echo get_template_directory_uri() . '/images/PREMIUM-THEME.png'; ?>"/>					
		</div>
				
		<div class="cb-center">			
			<img class="sb-demo" src="<?php echo get_template_directory_uri() . '/images/premium-options.png'; ?>"/>			
		</div>
